...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="cursor-pointer bg-purple-600 bg-opacity-70 w-full h-full
     hover:scale-105 duration-500 text-white shadow-md rounded-lg overflow-hidden">
      <img src={product.thumbnail} alt={product.title} className="w-full h-40 md:h-64 object-cover" />
      <div className="px-1 md:px-4 py-7">
        <h2 className="text-md md:text-2xl font-semibold hidden overflow-hidden">
          {product.title}
        </h2>
