    ...
    <div className="cursor-pointer bg-purple-600 bg-opacity-70 w-full hover:scale-105 duration-500 text-white shadow-md rounded-lg overflow-hidden">
      ...
      <div className="px-4 py-7">
        ...
        <div className="mr-5 pb-2">
          <p className="uppercase bg-purple-900 text-sm font-semibold inline-block px-3">
            {product.category}
          </p>
        </div>
        <Rating
          ...
          fullSymbol={"s"}
        />
        <p className="md:hidden mt-3 w-3/12 bg-purple-900 text-sm font-semibold  px-3">
          ${product.price}
        </p>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mt-5">
          ...
          <p className="hidden  bg-purple-900 text-sm font-semibold md:inline-block px-3">
            ${product.price}
          </p>
        </div>
      </div>
